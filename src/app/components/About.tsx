...
export default function About() {
  ...
  <img className='lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded' src={"https://static.vecteezy.com/system/resources/previews/010/519/639/original/a-girl-using-laptop-cartoon-character-free-vector.jpg"} alt='' width={50} height={50} />
